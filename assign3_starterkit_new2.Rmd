...
productCountryCluster3 <- subset(allProductCountryClusters, cluster = 3)
productCountryCluster4 <- subset(allProductCountryClusters, cluster = 4)
productCountryCluster5 <- subset(allProductCountryClusters, cluster = 5)


# for each product, get top 10 products

# cluster 1
countries1 <- unique(productCountryCluster1$Country)
stockCode1 <- unique(productCountryCluster1$StockCode)
countries1
stockCode1
desc1 <- unique(productCountryCluster1$Description)
desc1
...
stockcodes <- unique(top10cluster1extracted$StockCode)
stockcodes


descriptions <- unique(top10cluster1extracted$Description)
descriptions
...
# cluster 2
countries2 <- unique(productCountryCluster2$Country)
countries2
stockCode2 <- unique(productCountryCluster2$StockCode)
stockCode2
```
